    ...
    tagTable = $("#tag-table").dataTable($.fn.extend(true, {}, app.appOption.datatables.defaultOptions, {
        ...
        "columns": [{
            ...
            "render": function (data, type, row, meta) {
                return '<button onclick="tag.update(' + row.id + ')" class="btn btn-sm btn-app-primary tag-show-edit">' + editTagVue.message.button.edit + '</button>' + '<button onclick="tag.delete(' + row.id + ')" class="btn btn-sm btn-app-danger tag-show-delete">' + editTagVue.message.button.delete + '</button>';
            }
        }]
    })).api();
