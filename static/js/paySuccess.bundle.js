...
/* WEBPACK VAR INJECTION */(function(app, Vue, commonMsg) {var $ = __webpack_require__(0);
__webpack_require__(3);
...
var pay = {
    changeStatus: function () {
        ...
        if (app.appOption.getQueryParam("PayerID") == null) {
            ...
            url = app.appOption.url + "v1/api/payments/paypal/paySuccess/" + app.appOption.getQueryParam("shipperBidId") + "/" + app.appOption.getQueryParam("paymentId") + "/" + app.appOption.getQueryParam("PayerID");
        }
