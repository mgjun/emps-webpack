    ...
    leadTimeTable = $("#leadTime-table").dataTable($.fn.extend(true, {}, app.appOption.datatables.defaultOptions, {
        ...
        "columns": [{
            ...
            "render": function (data, type, row, meta) {
                return '<button onclick="leadTime.update(' + row.id + ')" class="btn btn-sm btn-app-primary leadTime-show-edit">' + editLeadTimeVue.message.button.edit + '</button>' + '<button onclick="leadTime.delete(' + row.id + ')" class="btn btn-sm btn-app-danger leadTime-show-delete">' + editLeadTimeVue.message.button.delete + '</button>';
            }
        }]
    })).api();
