...
$(document).ready(function () {
    ruleTable = $("#rule-table").dataTable($.fn.extend(true, {}, app.appOption.datatables.defaultOptions, {
        ...
        "columns": [{
            ...
            "render": function (data, type, row, meta) {
                console.log(row);
                return '<button onclick="rule.update(' + row.id + ')" class="btn btn-sm btn-app-primary rule-show-edit">' + editRuleVue.message.button.edit + '</button>' + '<button onclick="rule.delete(' + row.id + ')" class="btn btn-sm btn-app-danger rule-show-delete">' + editRuleVue.message.button.delete + '</button>';
            }
        }]
    })).api();
