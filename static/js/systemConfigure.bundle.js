    ...
    var datatable = $("#datatable").dataTable($.fn.extend(true, {}, app.appOption.datatables.defaultOptions, {
        ...
        "columns": [{
            ...
            "render": function (data, type, row, meta) {
                return '<button onclick="obj.update(' + row.id + ')" class="btn btn-sm btn-app-primary show-edit">' + editVue.message.button.edit + '</button>' + '<button onclick="obj.delete(' + row.id + ',\'' + row.countryName + '\')" class="btn btn-sm btn-app-danger show-delete">' + editVue.message.button.delete + '</button>';
            }
        }]
    })).api();
