...
$(document).ready(function () {
    additionalTable = $("#additional-table").dataTable($.fn.extend(true, {}, app.appOption.datatables.defaultOptions, {
        ...
        columns: [{
            ...
            searchable: false,
            render: function (data, type, row, meta) {
                return '<button id="edit-' + meta.row + '" onclick="additional.update(\'edit-' + meta.row + '\')" class="btn btn-sm btn-app-primary">' + vm.message.button.edit + '</button>' + '<button id="delete-' + meta.row + '" onclick="additional.delete(' + row.id + ')" class="btn btn-sm btn-app-danger">' + vm.message.button.delete + '</button>';
            }
        }]
    })).api();
