...
$(document).ready(function () {
    vehicleTypeTable = $("#vehicleType-table").dataTable($.fn.extend(true, {}, app.appOption.datatables.defaultOptions, {
        ...
        "columns": [{
            ...
            "searchable": false,
            "render": function (data, type, row, meta) {
                return '<button onclick="vehicleType.update(' + row.id + ')" class="btn btn-sm btn-app-primary vt-show-edit">' + vehicleEditVue.message.button.edit + '</button>' + '<button onclick="vehicleType.delete(' + row.id + ')" class="btn btn-sm btn-app-danger vt-show-delete">' + vehicleEditVue.message.button.delete + '</button>';
            }
        }]
    })).api();
