    ...
    zoneTable = $("#zone-table").dataTable($.fn.extend(true, {}, app.appOption.datatables.defaultOptions, {
        ...
        "columns": [{
            ...
            "render": function (data, type, row, meta) {
                return '<button onclick="zone.update(' + row.id + ')" class="btn btn-sm btn-app-primary zone-show-edit">' + editZoneVue.message.button.edit + '</button>' + '<button onclick="zone.delete(' + row.id + ')" class="btn btn-sm btn-app-danger zone-show-delete">' + editZoneVue.message.button.delete + '</button>';
            }
        }]
    })).api();
