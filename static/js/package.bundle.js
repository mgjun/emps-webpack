...
$(document).ready(function () {
    packageTable = $("#package-table").dataTable($.fn.extend(true, {}, app.appOption.datatables.defaultOptions, {
        ...
        "columns": [{
            ...
            "searchable": false,
            "render": function (data, type, row, meta) {
                return '<button onclick="packages.update(' + row.id + ')" class="btn btn-sm btn-app-primary package-show-edit">' + editPackageVue.message.button.edit + '</button>' + '<button onclick="packages.delete(' + row.id + ')" class="btn btn-sm btn-app-danger package-show-delete">' + editPackageVue.message.button.delete + '</button>';
            }
        }]
    })).api();
