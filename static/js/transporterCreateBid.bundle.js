...
$(document).ready(function () {
    ...
    $("#edit-price-save").bind("click", function () {
        var formObj = $("#edit-price-form"),
            validator = tcb.formValidate(formObj),
            priceObj = formObj.serializeObject(),
            currentTr = $("#edit_price_" + tcb.currentRowId).closest("tr"),
            radio = $(currentTr.find("td")[0]).find("input[type='radio']"),
            hasChecked = radio.closest("div").hasClass("checked"),
            rowData = transporterCreateTable.row(currentTr).data();
        if (!validator.form()) return;
...
var tcb = {
    ...
    initICheck: function () {
        ...
        $(".checked-row-class").on("ifChecked", function () {
            ...
            var currentRowObj = $(this).closest("tr"),
                currentRowData = transporterCreateTable.row(currentRowObj).data();
