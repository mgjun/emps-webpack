...
$(document).ready(function () {
    driverTable = $("#driver-table").dataTable($.fn.extend(true, {}, app.appOption.datatables.defaultOptions, {
        ...
        "columns": [{
            ...
            "searchable": false,
            "render": function (data, type, row, meta) {
                return '<button onclick="driver.update(' + row.id + ')" class="btn btn-sm btn-app-primary driver-show-edit">' + editDriverVue.message.button.edit + '</button>' + '<button onclick="driver.delete(' + row.id + ')" class="btn btn-sm btn-app-danger driver-show-delete">' + editDriverVue.message.button.delete + '</button>';
            }
        }]
    })).api();
