    ...
    distanceMatrixTable = $("#distanceMatrix-table").dataTable($.fn.extend(true, {}, app.appOption.datatables.defaultOptions, {
        ...
        "columns": [{
            ...
            "render": function (data, type, row, meta) {
                return '<button onclick="distanceMatrix.update(' + row.id + ')" class="btn btn-sm btn-app-primary distanceMatrix-show-edit">' + distanceMatrixVue.message.button.edit + '</button>' + '<button onclick="distanceMatrix.delete(' + row.id + ',\'' + row.destCentralAddress + '\')" class="btn btn-sm btn-app-danger distanceMatrix-show-delete">' + distanceMatrixVue.message.button.delete + '</button>';
            }
        }]
    })).api();
